package io.oauth.resourceserverrolesresources.security.resolver;

import com.nimbusds.jwt.JWTParser;
import io.oauth.resourceserverrolesresources.security.converter.CustomJwtAuthenticationConverter;
...
public class CustomJwtIssuerAuthenticationManagerResolver implements AuthenticationManagerResolver<HttpServletRequest> {
    ...
    private static class ResolvingAuthenticationManager implements AuthenticationManager{
        ...
        private final Converter<BearerTokenAuthenticationToken, String> issuerConverter = new CustomJwtIssuerAuthenticationManagerResolver.JwtClaimIssuerConverter();
